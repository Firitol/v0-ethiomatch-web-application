      ...
      <div className="max-w-2xl w-full">
        ...
        <div className="text-center mb-12">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <h1 className="text-4xl font-bold text-foreground">Ethiomatch</h1>
          </div>
          <p className="text-xl text-foreground">Find Meaningful Connections</p>
          <p className="text-sm text-muted-foreground mt-2">Select a profile to get started</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          {users.map((user) => (
            <Card
              key={user.id}
              className="hover:shadow-lg transition-all cursor-pointer border-2 border-transparent hover:border-primary/30"
